...
public class SheathController {
    ...
    public Result findSheathQuery(@RequestParam Integer page, @RequestParam Integer size, @RequestBody Sheath sheath) {

        Page<Sheath> sheathPage = sheathService.findSheathQuery(page, size, sheath);
