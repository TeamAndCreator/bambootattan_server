...
public class UnderstemController {
    ...
    public Result findUnderstemQuery(@RequestParam Integer page, @RequestParam Integer size, @RequestBody Understem understem) {

        Page<Understem> understemPage = understemService.findUnderstemQuery(page, size, understem);
